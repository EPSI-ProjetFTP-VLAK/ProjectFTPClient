...
public class RemoteExplorerControllerTest {
    ...
    private RemoteExplorerController remoteExplorerController;
    private TreeItem<String> rootNode;

    @Before
    public void setUp() throws Exception {
        remoteExplorerController = new RemoteExplorerController();
        remoteExplorerController = Mockito.spy(remoteExplorerController);

        Mockito.when(remoteExplorerController.getHostName()).thenReturn(HOSTNAME);
        ...
        remoteExplorerController.generateChildNodes(rootNode);
    }
    ...
    public void testGenerateRootNode() throws Exception {
        TreeItem<String> rootNode = remoteExplorerController.generateRootNode();
